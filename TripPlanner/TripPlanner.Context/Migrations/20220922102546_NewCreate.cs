    ...
    public partial class NewCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("e3d694f0-d921-43b9-8a5c-f2b4c8e28e11"), "2", "User", "User" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("e41581ea-fc9b-4317-8945-199c92473e7a"), "1", "BTO", "Business Trip Operator" });
